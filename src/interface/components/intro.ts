...
import { getModelDisplayName } from '@/common/utils/model.js';
...
export class IntroComponent extends Container {
  ...
  constructor(model: string) {
    ...
    const welcomeText = 'Welcome to Sentinel AI';
...
╚══════╝╚══════╝╚═╝  ╚═══╝   ╚═╝   ╚═╝╚═╝  ╚═══╝╚══════╝╚══════╝`,
    ...
    this.addChild(new Spacer(1));
    this.addChild(new Text('AI-powered financial intelligence platform.', 0, 0));
