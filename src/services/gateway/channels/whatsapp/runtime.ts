import { monitorWebInbox } from '@/services/gateway/channels/whatsapp/inbound.js';
import { setActiveWebListener } from '@/services/gateway/channels/whatsapp/outbound.js';
import { logout } from '@/services/gateway/channels/whatsapp/auth-store.js';
import type { WhatsAppInboundMessage } from '@/services/gateway/channels/whatsapp/types.js';
import type { ReconnectPolicy } from '@/services/gateway/channels/whatsapp/reconnect.js';
import { computeBackoff, DEFAULT_RECONNECT_POLICY } from '@/services/gateway/channels/whatsapp/reconnect.js';
