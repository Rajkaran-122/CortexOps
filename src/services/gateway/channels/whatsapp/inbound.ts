...
import { createWaSocket, getStatusCode, isLoggedOutReason, waitForWaConnection } from '@/services/gateway/channels/whatsapp/session.js';
import type { WhatsAppCloseReason, WhatsAppInboundMessage } from '@/services/gateway/channels/whatsapp/types.js';
import { setActiveWebListener } from '@/services/gateway/channels/whatsapp/outbound.js';
import { isRecentInboundMessage } from '@/services/gateway/channels/whatsapp/dedupe.js';
import { readSelfId } from '@/services/gateway/channels/whatsapp/auth-store.js';
import { checkInboundAccessControl } from '@/services/gateway/access-control.js';
import { resolveJidToPhoneJid, type LidLookup } from '@/services/gateway/channels/whatsapp/lid.js';
