import { createChannelManager } from '@/services/gateway/channels/manager.js';
import { createWhatsAppPlugin } from '@/services/gateway/channels/whatsapp/plugin.js';
import {
  assertOutboundAllowed,
  sendComposing,
  sendMessageWhatsApp,
  type WhatsAppInboundMessage,
} from '@/services/gateway/channels/whatsapp/index.js';
import { resolveRoute } from '@/services/gateway/routing/resolve-route.js';
import { resolveSessionStorePath, upsertSessionMeta } from '@/services/gateway/sessions/store.js';
import { loadGatewayConfig, type GatewayConfig } from '@/services/gateway/config.js';
import { runAgentForMessage, isSessionRunning, enqueueForSession } from '@/services/gateway/agent-runner.js';
import { cleanMarkdownForWhatsApp } from '@/services/gateway/utils.js';
import { startCronRunner } from '@/services/cron/runner.js';
import { ensureHeartbeatCronJob } from '@/services/cron/heartbeat-migration.js';
import {
  isBotMentioned,
  recordGroupMessage,
...
} from '@/services/gateway/group/index.js';
import type { GroupContext } from '@/core/orchestrator/prompts.js';
import { appendFileSync } from 'node:fs';
import { sentinelPath } from '@/common/utils/paths.js';
import { getSetting } from '@/common/utils/config.js';

const LOG_PATH = sentinelPath('gateway-debug.log');
