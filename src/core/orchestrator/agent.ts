...
import { callLlmWithMessages, streamLlmWithMessages } from '@/core/llm/llm.js';
import { getTools, getToolConcurrencyMap } from '@/plugins/tools/registry.js';
import { buildSystemPrompt, loadSoulDocument, loadRulesDocument } from '@/core/orchestrator/prompts.js';
import { extractTextContent, hasToolCalls } from '@/common/utils/ai-message.js';
import { InMemoryChatHistory } from '@/common/utils/in-memory-chat-history.js';
import { estimateTokens, getAutoCompactThreshold, KEEP_TOOL_USES } from '@/common/utils/tokens.js';
import { exceedsSizeCap, persistLargeResult, buildPersistedContent } from '@/common/utils/tool-result-storage.js';
import { enforceResultBudget } from '@/common/utils/tool-result-budget.js';
import { formatUserFacingError, isContextOverflowError } from '@/common/utils/errors.js';
import type { AgentConfig, AgentEvent, CompactionEvent, ContextClearedEvent, MicrocompactEvent, QueueDrainEvent, TokenUsage } from '@/core/orchestrator/types.js';
import type { MessageQueue } from '@/common/utils/message-queue.js';
import { compactContext, MAX_CONSECUTIVE_COMPACTION_FAILURES, MIN_TOOL_RESULTS_FOR_COMPACTION } from '@/core/orchestrator/compact.js';
import { microcompactMessages } from '@/core/orchestrator/microcompact.js';
import { createRunContext, type RunContext } from '@/core/orchestrator/run-context.js';
import { AgentToolExecutor } from '@/core/orchestrator/tool-executor.js';
import { MemoryManager } from '@/core/memory/index.js';
import { runMemoryFlush, shouldRunMemoryFlush } from '@/core/memory/flush.js';
