...
import type { SkillMetadata, Skill, SkillSource } from '@/plugins/workflows/types.js';
import { extractSkillMetadata, loadSkillFromPath } from '@/plugins/workflows/loader.js';
...
const SKILL_DIRECTORIES: { path: string; source: SkillSource }[] = [
  ...
  { path: join(process.cwd(), sentinelPath('skills')), source: 'project' },
];
