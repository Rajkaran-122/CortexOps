 ...
 * Adapted for Sentinel's LangChain DynamicStructuredTool + Zod framework.
 *
...
import { wrapExternalContent, wrapWebContent } from '@/plugins/tools/fetch/external-content.js';
import {
  ...
  truncateText,
  type ExtractMode,
} from '@/plugins/tools/fetch/web-fetch-utils.js';
import {
  type CacheEntry,
  ...
  withTimeout,
  writeCache,
} from '@/plugins/tools/fetch/cache.js';
...
// ============================================================================
// Tool definition (adapted for Sentinel's LangChain + Zod framework)
// ============================================================================
