...
- Repo: https://github.com/<your-username>/sentinel-ai
- Sentinel AI is a CLI-based AI agent for deep financial research, built with TypeScript, Ink (React for CLI), and LangChain.
...
- Config: `.sentinel/settings.json` (persisted model/provider selection)
...
- Config stored in `.sentinel/settings.json` (gitignored).
